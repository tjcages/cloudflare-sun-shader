...
export type ProfilesShaderConfig = {
  ...
  // Depth splice — vertical blend from lit photo (top) to raw depth map (bottom)
  depthSpliceEnabled: boolean
  /** UV.y of the transition center — 0 bottom, 1 top. */
  depthSplicePosition: number
  /** Width of the photo ↔ depth gradient (UV units). */
  depthSpliceSoftness: number
}
...
export const PROFILES_SHADER_DEFAULTS: ProfilesShaderConfig = {
  ...
  light1Enabled: true,
  light1Color: "#ff5e1f",
  light1Pos: [-0.5448265255905511, -0.8285925196850394],
  light1Z: 0.6,
  light1Radius: 1.16,
  light1Intensity: 1,
  light1Diffuse: 0.55,
  ...
  light2Enabled: true,
  light2Color: "#ffa50a",
  light2Pos: [0.4679010826771655, -0.8899483267716537],
  light2Z: 0.5,
  light2Radius: 0.83,
  light2Intensity: 0.8,
  light2Diffuse: 0.55,
  ...
  overlaySpeed: 0.5,
  overlayDepthMin: 0,
  overlayScanOnly: false,
  depthSpliceEnabled: true,
  depthSplicePosition: 0.2,
  depthSpliceSoftness: 0.5,
}
// @shader-config-end
